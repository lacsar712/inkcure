...
function renderSnapshot(snap) {
  ...
  document.getElementById("pressure").textContent = snap.cureline.steam_pressure_psi.toFixed(0);
  document.getElementById("mw").textContent = snap.cureline.output_mw.toFixed(1);
  document.getElementById("inkvat-level").textContent = snap.inkvat.level_percent.toFixed(1);
  document.getElementById("burner").textContent = snap.uvbank.burner_phase;
  document.getElementById("o2").textContent = snap.uvbank.excess_o2_pct.toFixed(2);
  trendData.push(snap.cureline.steam_pressure_psi);
...
document.getElementById("btn-dwell").addEventListener("click", () => postAction("/dwell/start?holder=hmi"));
document.getElementById("btn-dwell-done").addEventListener("click", () => postAction("/dwell/complete?holder=hmi"));
