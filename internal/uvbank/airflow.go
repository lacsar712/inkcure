...
func (a *AirflowBalancer) WithinLimits(reading model.UvbankReading) bool {
	o2 := reading.ExcessO2Pct
	return o2 >= model.MinLampframeO2Percent && o2 <= model.MaxLampframeO2Percent
}
